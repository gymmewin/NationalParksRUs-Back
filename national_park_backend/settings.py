"""
Django settings for national_park_backend project.
...
SECRET_KEY = 'django-insecure-h=m-*hd4zt-5&_+1%!(l!79*wgr%hjzppe-#gi6n9@!i(s&q&y'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', 'natl-parks-r-us-back.herokuapp.com']
...
ROOT_URLCONF = 'national_park_backend.urls'
...
WSGI_APPLICATION = 'national_park_backend.wsgi.application'
